                                        ...
                                        <tbody>    
                                            <?php foreach ($agenda as $age) { ?>                                    
                                                <tr>                                                    
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('atendimento/') ?>" class="btn btn-success btn-group" onclick="return confirm('Ir Para o Atendimento?');" >Atendimento</a>
                                                        <a href="<?= base_url('agenda/editar/' . $age->cod_agenda) ?>" class="btn btn-primary btn-group" onclick="return confirm('Editar Agendamento?');" >Editar</a>                                                        
                                                        <a href="<?= base_url('agenda/excluir/' . $age->cod_agenda) ?>" class="btn btn-danger btn-group" onclick="return confirm('Este agendamento será removido! Continuar?');">Remover</a>
                                                    </td>
                                                </tr>                               
                                            <?php } ?>   
                                        </tbody>
