                                ...
                                <form class="form-control form-horizontal " action="<?= base_url(); ?>login/salvar_atualizacao" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" id="data_nasc" name="data_nasc" value="<?= $login[0]->data_nascimento; ?>" required>
                                            </div>
                                        </div>  
                                        <div class="form-group row">
                                    ...
                                    <div class="border-top">
                                        <div class="card-body">
                                            ...
                                            <a type="reset" class="btn btn-danger" href="<?= base_url() ?>login">Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
